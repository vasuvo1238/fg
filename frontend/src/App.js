...
import { AlertCircle, Send, Sparkles, TrendingUp, DollarSign, PieChart, BarChart3, MessageCircle } from "lucide-react";
...
function App() {
  ...
  const [activeView, setActiveView] = useState("chat"); // "chat", "stocks", "options"
